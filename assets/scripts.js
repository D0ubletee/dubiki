...
function fotoKt() {
    ...
    var e1 = document.getElementById('ftAk');
    e1.classList.add("lopdeg");
}
...
function fireworksPlay() {
    var fireworks = new Audio('assets/fireworks.mp3');
    fireworks.play();
    fireworks.loop = true
    if (fireworks.currentTime === 20) {
        fireworks.pause()
    }
}
...
function duar() {
    ...
    if (a == text4.length) {
        document.getElementById("text4").innerHTML = "Loveyoumore Sayang &#9829;";
